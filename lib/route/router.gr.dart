...
class RootRouter extends _i10.RootStackRouter {
  ...
  List<_i10.RouteConfig> get routes => [
        ...
        _i10.RouteConfig(FirstRoute.name, path: '/first'),
        _i10.RouteConfig(SecondRoute.name, path: '/second'),
        _i10.RouteConfig(ThirdRoute.name, path: '/third'),
        _i10.RouteConfig(ForthRoute.name, path: '/third'),
        _i10.RouteConfig(WelcomeRoute.name, path: '/welcome'),
        _i10.RouteConfig(LoginRoute.name, path: '/login'),
        _i10.RouteConfig(SignInRoute.name, path: '/signin'),
        _i10.RouteConfig(ForgotPasswordRoute.name, path: '/forgot')
      ];
}
...
/// generated route for
/// [_i4.ThirdScreen]
class ThirdRoute extends _i10.PageRouteInfo<void> {
...
/// generated route for
/// [_i5.ForthScreen]
class ForthRoute extends _i10.PageRouteInfo<void> {
